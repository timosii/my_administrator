...
stop:
	docker stop my_administrator-app-1 my_administrator-db-1 my_administrator-redis-1

start:
	docker start my_administrator-app-1 my_administrator-db-1 my_administrator-redis-1

delete:
	docker rm my_administrator-app-1 my_administrator-db-1 my_administrator-redis-1
