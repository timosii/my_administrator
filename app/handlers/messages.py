...
class ErrorMessages:
    network_error = 'Проблема соединения с сервером Телеграм, подождите пару секунд'
    server_error = 'Проблема с серверами Телеграм'
    too_long_message = 'Сообщение слишком длинное'
...
class MoPerformerMessages:
    ...
    can_continue_check = 'Вы можете продолжить проверку или закончить её (доступно, если активных нарушений нет)'
