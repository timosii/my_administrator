...
class MoPerformerMessages:
    start_message = f"{form_greeting()}, исполнитель МО! Вы можете выбрать активные уведомления, активные проверки или перенесенные нарушения"
    ...
    move_to_pending_alert = 'Нарушение будет находится в статусе "Перенесено" и не отображаться среди других нарушений.\nВы сможете найти такие нарушения в пункте "Перенесенные нарушения" главного меню'
