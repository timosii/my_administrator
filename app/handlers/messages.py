...
class AuthorizationMessages:
    ...
    incorrect_pass = 'Пароль неверный! Обратитесь к администратору или заново нажмите /start, если просто ошиблись'
...
class MfcMessages:
    ...
    choose_zone_with_time_task = f'Вы создали уведомление {time_determiner()}. Выберите зону нарушения: '
