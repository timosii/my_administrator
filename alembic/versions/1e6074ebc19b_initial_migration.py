...
Revision ID: 1e6074ebc19b
Revises: 80d894a817dd
Create Date: 2024-05-29 22:49:54.009573
...
revision: str = '1e6074ebc19b'
down_revision: Union[str, None] = '80d894a817dd'
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['mo_user_id'], ['data.user.id'], ),
