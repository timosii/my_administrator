...
Revision ID: 8a8f4b7d29b1
Revises: 6612fc4ffeb5
Create Date: 2025-01-07 21:40:09.662641
...
revision: str = '8a8f4b7d29b1'
down_revision: Union[str, None] = '6612fc4ffeb5'
...
def upgrade() -> None:
    ...
    op.create_table('violations_dgp',
...
def downgrade() -> None:
    ...
    op.drop_table('violations_gp', schema='dicts')
    op.drop_table('violations_dgp', schema='dicts')
